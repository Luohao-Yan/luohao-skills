...
# === 改成你机器上 autodeck skill 的 scripts 目录 ===
# (装了本 skill后,通常是 ~/.claude/skills/autodeck/scripts 或 ~/.agents/skills/autodeck/scripts)
SKILL_SCRIPTS = r"<改成 autodeck skill 的 scripts 目录>"
